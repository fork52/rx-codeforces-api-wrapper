...
public class ProblemResult {
    ...
    /**
     * The type of the problem result, which can be PRELIMINARY or FINAL.
     * If the type is PRELIMINARY, the points can decrease if, for example, the solution fails during system testing.
     * Otherwise, the party can only increase points for this problem by submitting better solutions.
     */
    private ResultType type;

    /**
     * The number of seconds after the start of the contest before the submission that brought the maximal amount of points for this problem.
