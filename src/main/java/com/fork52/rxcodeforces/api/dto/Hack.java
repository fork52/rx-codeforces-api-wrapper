...
public class Hack {
    ...
    /**
     * The judge protocol for the hack, including fields "manual", "protocol", and "verdict".
     * Field "manual" can have values "true" and "false". If manual is "true", then the test for the hack was entered manually.
     * Fields "protocol" and "verdict" contain a human-readable description of the judge protocol and hack verdict.
